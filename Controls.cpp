...
void CCheckBox::Draw(bool hover)
{
	...
	Render::Outline(a.x, a.y, 13, 13, Color(129, 129, 129, 255));

	if (hover)
	{
		if (Checked)
		{
			Render::Clear(a.x + 2, a.y + 2, 9, 9, Color(102, 255, 102, 255));
		}
		else
		{
...
void CSlider::Draw(bool hover)
{
	...
	Render::Clear(a.x + Location, a.y + 1, 4, 9, Color(102, 255, 102, 255));
...
void CComboBox::Draw(bool hover)
{
	...
	if (Items.size() > 0)
	{
		...
		if (IsOpen)
		{
			Render::Clear(a.x, a.y + 17, m_iWidth, Items.size() * 16, Color(161, 161, 161, 255));
