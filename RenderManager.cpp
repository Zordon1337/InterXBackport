...
void Render::Initialise()
{
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuBold, "Tahoma", 13, 600, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESP, "Tahoma", 16, 500, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
...
std::wstring Render::stringToWide(const std::string& text)
{
...
int Render::getWidht(unsigned long font, const char* input)
{
	INT iWide = 0;
	INT iTall = 0;
	...
	Interfaces::Surface->GetTextSize(font, pszUnicode, iWide, iTall);
...
void Render::DrawStringA(unsigned long font, bool center, int x, int y, int r, int g, int b, int a, const char *input, ...)
{
	...
	Interfaces::Surface->DrawSetTextColor(Color(r, g, b, a));
