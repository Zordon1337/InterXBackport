...
public:
	...
	VectorAligned& operator=(const Vector &_v);
};

__forceinline VectorAligned::VectorAligned() {
	this->x = this->y = this->z = 0.0f;
}
__forceinline VectorAligned::VectorAligned(float _x, float _y, float _z) {
	this->x = _x;
	this->y = _y;
	this->z = _z;
}

__forceinline VectorAligned& VectorAligned::operator=(const Vector &_v) {
	this->x = _v.x;
	this->y = _v.y;
	this->z = _v.z;
	return *this;
...
public:
	...
	{
		typedef void(__thiscall* SetStringFn)(void*, const char*);
		return call_vfunc<SetStringFn>(this, 14 /*13*/)(this, str);
	}
