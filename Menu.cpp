...
void MainWindow::Setup()
{
	...
	SetTitle("InterX for Counter Strike: Global Offensive");
...
#pragma region Target
	TargetGroup.SetPosition(16, 444);
...
#pragma region Accuracy
	...
	AccuracyGroup.PlaceLabledControl("Hitchance", this, &AccuracySpreadLimit);
...
#pragma region AntiAim
	AntiAimGroup.SetPosition(408, 444);
...
#pragma region Other
	...
	OtherChatSpam.AddItem("CLOWN'S HOOK");
	OtherChatSpam.AddItem("GAY SPAM");
...
#pragma region Fakelag
	FakeLagGroup.SetText("Name Changers");
	...
	FakeLagGroup.PlaceLabledControl("AIMWARE.NET", this, &OtherAimware);
	
	OtherInterwebz.SetFileId("otr_interwebz");
	FakeLagGroup.PlaceLabledControl("INTERWEBZ.CC", this, &OtherInterwebz);

	OtherClowns.SetFileId("otr_clowns");
	FakeLagGroup.PlaceLabledControl("CLOWN'S HOOK", this, &OtherClowns);
